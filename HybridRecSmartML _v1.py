...
if __name__ == "__main__":
    ...
    print_formatted_recommendations(similar_products[['category_name', 'product_id', 'score', 'filter_type']].values.tolist(), recommender.products_df)

    # Example: Get recommendations for user 101 with two-hop traversal, limited to top 5, excluding already purchased products
    customer_id = "9688698233771944"
